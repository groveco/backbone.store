...
describe('Axios HTTP Client', () => {
  ...
  describe('dynamic options via "Interceptor" options', () => {
    ...
    it('Calls response handler when request is successful for internal requests', async () => {
      const options = {
        urlPrefix: 'http://my.testapi.co/api',
    ...
    it('Calls response handler when request errors for internal requests', async () => {
      const options = {
        urlPrefix: 'http://my.testapi.co/api',
        responseInterceptor: jest.fn()
      }
      ...
      axiosMockAdapter.onGet(/.*/g).reply(404)
